...
= Can you make me a customized version that works a little differently? =

If you are willing to pay for my work, yes.

= My question isn't answered here! There are a lot of questions answered in the comments section of my website. =

[Visit this plugin's home page on my website.](http://www.tacticaltechnique.com/wordpress/latest-twitter-sidebar-widget/)
...
= 0.120307 =
* Fixed a bug I introduced in the previous version that stopped displaying the title

= 0.120303 = 
* Converted code to use 2.8 Widgets API
* Introduced use of HTTP API via wp_remote_get( )
* Improved fail safe logic to prevent absence of tweets
* Now plays nice with $before_title, $after_title, $before_widget and $after_widget
* CSS rules for #latest-twitter-widget change to .widget_latest_twitter_widget
...
= 0.120307 = 
You want this version because I made a mistake in the previous version. This version fixes a problem where the widget title doesn't display.

= 0.120303 =
This is a significant breaking change. By breaking change, I mean this update will clear the widget settings and remove the widget from your sidebars. This is necessary because I converted the entire plugin code to use the 2.8 Widgets API. This means this plugin now plays nice with other plugins that modify widgets, and you can now use more than one instance of this plugin in sidebars. The CSS styling will also work differently. You can backup your existing .css file in the plugin folder and compare the two, or just change your #latest-twitter-widget rules to .widget_latest_twitter_widget rules.
