...
if ($have_innodb[0]['Value'] == 'YES' && $details_wp_slim_tables[0]['Engine'] == 'MyISAM') echo '[<a href="?page=wp-slimstat/admin/options/index.php&engine=innodb&slimpanel=5">'.__('switch to InnoDB','wp_slimstat_options')."</a> $note_too_many_rows]<br/>";
